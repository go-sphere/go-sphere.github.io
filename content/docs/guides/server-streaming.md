...
generated HTTP endpoint works through `httpx` on net/http, Gin, Echo, Hertz, and
Fiber; it is independent of any gRPC stream generated by `protoc-gen-go-grpc`.
...
- net/http (`stdx`), Gin, Echo, and Hertz also expose `httpx.Flusher`; Fiber does not. Prefer
